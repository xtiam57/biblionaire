...
export const questions: IQuestion[] = [
  ...
  {
    difficulty: Difficulty.VERY_HARD,
    question: '¿Quién dijo \'Mi corazón se regocija en Jehová, Mi poder se exalta en Jehová; Mi boca se ensanchó sobre mis enemigos, Por cuanto me alegré en tu salvación\'?',
    options: [
      'Ana',
      'David',
      'Jeremías',
